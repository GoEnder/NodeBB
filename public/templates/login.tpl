...
<div class="row">
	<div class="well {login_window:spansize}">
		...
		<div class="alert-box alert" id="error" style="display:none">
		...
		<form>
		  <div class="large-6 columns">
  			...
  			<button class="button" id="login" type="submit">Login</button> &nbsp; <a href="/reset">Forgot Password?</a>
  		</div>
		</form>
		
		<div id="login-error-notify" class="alert-box alert hide">Invalid username/password</div>
	</div>
	
	<div class="panel large-6 columns {alternate_logins:display}">
